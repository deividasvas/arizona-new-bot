...
const {EmbedBuilder, Colors, MessageType} = require("discord.js");
...
const {
    getGuildRolesId,
    getGuildChannelsId,
    getGuildCategoriesId,
    fromPostToPostList: getFromPostToPostList,
    whiteListRoles: getWhiteListRoles
} = require("../configs/settings.js");

// Функция для обработки команд в личных сообщениях.
const commandDirectMessageHandler = async (bot, message) => {
